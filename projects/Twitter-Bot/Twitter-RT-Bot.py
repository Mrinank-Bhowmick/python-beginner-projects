...
rule = tweepy.StreamRule("(#Python OR #python OR #programming OR #coding) (-is:retweet -is:reply)")  # setting rule on what topics you want to Retweet and not to add replies and retweets. This will only pickup the original tweets, you may wish to add functionalities according to your requirements
