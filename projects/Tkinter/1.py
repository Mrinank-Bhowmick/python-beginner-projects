...
class std_ca(tk.Frame):
	def __init__(self, parent, controller):
		...
		label_lp = ttk.Label(self, text ="You are Student or College Authority ?", font=("Times New Roman",36))
		label_lp.place(x=400,y=100)
		button_std = ttk.Button(self, text ="Student",command = lambda : controller.show_frame(LandPage))
		button_std.place(x=550,y=200,height=60,width=150)

		button_ca = ttk.Button(self, text ="College Authority",command = lambda : controller.show_frame(LandPage))
...
class LandPage(tk.Frame):
	def __init__(self, parent, controller):
		...
		button1 = ttk.Button(self, text ="Create New Account",command = lambda : controller.show_frame(accnt))
		button1.place(x=550,y=200,height=60,width=150)

		button2 = ttk.Button(self, text ="Login",command = lambda : controller.show_frame(lgin))
		button2.place(x=800,y=200,height=60,width=150)

		button_back = ttk.Button(self, text ="Back",command = lambda : controller.show_frame(std_ca))
...
class accnt(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		label.grid(row = 0, column = 6, padx = 10, pady = 10)
                #Name
		label_name=ttk.Label(self,text="Enter your Name:",font=('Times New Roman',14))
		...
		#email
		label_mail=ttk.Label(self,text="Enter your email:",font=('Times New Roman',14))
		...
		#dept
		ttk.Label(self,text="Select Department",font=('Times New Roman',14)).grid(row=3,column=4,padx=10,pady=25)
		n=tk.StringVar()
		...
		dept_chs.current()
		#College roll
		label_roll=ttk.Label(self,text="Enter your Roll No.:",font=('Times New Roman',14))
		...
		#year
		ttk.Label(self,text="Select current year:",font=('Times New Roman',14)).grid(row=4,column=4,padx=10,pady=25)
		n=tk.StringVar()
		dept_chs=ttk.Combobox(self,width=10,textvariable=n)
		...
		dept_chs.current()
		#gender
		ttk.Label(self,text="Enter Gender:",font=("Times New Roman",14)).grid(row=5,column=4,padx=10,pady=10)
		var=tk.IntVar()
		...
		#declaration
		chk=ttk.Checkbutton(self,text="I hereby declare that all the informations provided are correct. ")
		chk.grid(row=7,column=5,padx=10,pady=10)
		#password
		label_pass=ttk.Label(self,text="Enter your Password:",font=('Times New Roman',14))
		...
		# Return home
		button1 = ttk.Button(self, text ="Return to Home page",command = lambda : controller.show_frame(LandPage))
...
class lgin(tk.Frame):
	def __init__(self, parent, controller):
		...
		#back button
		button2 = ttk.Button(self, text ="Back",command = lambda : controller.show_frame(LandPage))
