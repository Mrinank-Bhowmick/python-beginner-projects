...
class TestItemsDB(unittest.TestCase):
    ...
    def test_insert_items(self):
        ...
        # Inserting One Item
        new_item = Item.create_income_item('APL Dividend',
                                           600,
    ...
    def test_upsert_item(self):
        ...
        items = [item for item in self.items_db.get_all_items() if item.name == 'Ethereum']
        self.assertEqual(len(items), 1)
    ...
    def setUp(self):
        ...
        self.items = \
            [Item.create_income_item('Bitcoin',
             ...
             Item.create_income_item('Stock Dividends',
                                     5,
             ...
             Item.create_expense_item('Car Gas',
                                      -300,
                                      "Car Gas Expense",
                                      '2024-04-20',
                                      Category('Transportation')
