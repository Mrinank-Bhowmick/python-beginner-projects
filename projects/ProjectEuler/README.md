...
```text
$ python "Problem 1/p1.py"
233168

$ python "Problem 2/p2.py"
4613732

$ python "Problem 7/p7.py"
104743
```

Each script prints a single number — the answer to that problem — and exits immediately.

## How to run on localhost

Each problem lives in its own `Problem N` folder. Run a solution directly, e.g.:
