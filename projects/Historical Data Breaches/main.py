...
for breach in dataset:
    if (breach["Name"].lower() == organisation.lower() or breach["Domain"].lower() == organisation.lower()):
        print("\nName:", breach["Name"])
        ...
        regex_pattern2 = r'</a>'
        print("Description:", re.sub(regex_pattern2, '', (re.sub(regex_pattern1, '', breach["Description"]))))
