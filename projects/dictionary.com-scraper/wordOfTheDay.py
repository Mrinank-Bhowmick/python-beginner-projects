...
def main():
	...
	data = get_soup(URL)
	word = get_word(data)
	choice = int(input("Do you want to know the meanings of the word ? Press 1.. else Press 0\n"))
	if choice == 1:
		get_word_meanings(data, word)
	else:
		pass
	print("\n")
	choice = int(input("Do you want to know how the word is pronounced ? Press 1.. else Press 0\n"))
	if choice == 1:
		get_TTS(word)
	else:
		pass
	print("\n")
	choice = int(input("Do you want to know more about the word ? Press 1.. else Press 0\n"))
	if choice == 1:
