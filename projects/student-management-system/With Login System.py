...
mycursor.execute("create table if not exists studentsinfo(sch_no int(50),name char(100),age int(50),email varchar(150),phone varchar(150))")
...
def login():
    ...
    mycursor.execute("select * from admin where id=('"+id+"') and password=('"+password+"')")
    result=mycursor.fetchall()
    if len(result)==1:
        print("-------------------------------------")
