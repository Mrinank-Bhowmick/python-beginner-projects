# === Game of Cricket · annotated for the pyBegin playground ===
# A beginner-friendly walkthrough — original project by @whoisjayd.

import random


# Ask the user to pick a number 1–6
def get_user_choice():
    while True:
        try:
...
# Simulate one full innings for a player
def play_innings(player, overs, max_wickets):
    ...
    # Keep playing until wickets or overs are used up
    while wickets < max_wickets and balls < overs * 6:
        try:
            ...
            # Same number means a wicket falls
            ...
            # Print over summary every 6 balls
            if balls % 6 == 0:
                over_number = balls // 6
